<?php
    ...
    set_time_limit(3000); 
    $emails1 = imap_search($inbox,'UNSEEN SUBJECT "Transaction Feed" SINCE "31 January 2017" FROM "distserve@franklintempleton.com"');
    if($emails1) {         // FRANKLIN
        $count = 1;
        //echo "EMAIL:-";
        print_r($emails1);
