<?php
    ...
    // Password of Karvy - for the zip file
    $pword = "Devmantra@123";
    ...
    set_time_limit(3000); 
    $emails2 = imap_search($inbox,'UNSEEN SUBJECT "Subscribed Transaction Feeds Report for Ref.no." SINCE "31 January 2018" FROM "distributorcare@kfintech.com"'); 
    print_r($emails2);
    ...
    if($emails2) {        // KARVY
        ...
        foreach($emails2 as $email_number) {
            ...
            //print_r($overview);
            // echo "<br>";
            echo "<br>DATE FROM:-".$overview[0]->date."<br>";//."<br><br><br>";
       ...
       /* echo "<br>";
        ...
        foreach ($last_karvy_ids as $karvy_email_number) 
        {
            ...
            // }
            //echo "Specified Link:-";
            //echo "<a href=".$karvy_links[1].">".$karvy_links[1]."</a><br><br><br>";
           /* if($karvy_link) 
            {*/
