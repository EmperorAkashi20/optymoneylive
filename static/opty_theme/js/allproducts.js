      ...
      success: function (response) {
         ...
         if (response) {
            ...
            for (var i = originalData.length - 1; i >= 0; i--) {
               ...
               $("#all_pr_fetch").prepend("<a class='col-md-12 singleproduct' href='single_product.html?" + window.btoa(originalData[i].pk_nav_id) + "?" + window.btoa(nav1Y) + "' data-navid='"+originalData[i].pk_nav_id+"' data-nav1y='"+nav1Y+"' style='color: #000000; padding-bottom: 5px;'> <div class='card'> " +
         ...
         success: function (response) {
            ...
            if (response) {
               ...
               for (var i = originalData.length - 1; i >= 0; i--) {
                  ...
                  tempDisplay = tempDisplay + "</div></div>";
                  //console.log("NAV"+nav);
                  $("#all_pr_fetch").prepend("<a class='col-md-12' href='single_product.html?" + window.btoa(originalData[i].pk_nav_id) + "?" + window.btoa(nav1Y) + "' style='color: #000000; padding-bottom: 5px;'> <div class='card'> " +
                     "<div class='card-body'><div class='row'><div class='col-md-6 ml-4'><h6>" + originalData[i].scheme_name + "</h6><div class='badge btn-primary'>" + ucfirst(originalData[i].scheme_type) + " <i class='fas fa-star' style='font-weight: 510; font-size: 10px;'></i></div></div>" + tempDisplay + "</div></div></div></a>");
               }
            }
         }
