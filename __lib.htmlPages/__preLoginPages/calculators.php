...
<div class="service_area plan_goal wealth_goal mb-20">
    <div class="container">
                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 text-center">
                            <input type="button" class="btn add_btn btn-sm" value="Check SIP" id="checkSIPBtn" name="">
                            <input type="reset" value="Recompute" id="sipRecompute" class="btn btn-default btn-sm">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row form-group text-center">
                                <div class="col-sm-12 col-md-offset-2 ml-5">
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                   ...
                   <div class="row form-group">
                        ...
                        <div class="col-sm-12 text-center">
                            <input type="button" class="btn add_btn btn-sm" value="Check Lumpsum" id="checkLumpsumBtn" name="">
                            <input type="reset" value="Recompute" id="lumpsumRecompute" class="btn btn-default btnsize">
                        </div>
                    </div>
                </div>
                    ...
                    <h6>Output</h6>
                       <div class="row">
                            ...
                            <div class="row form-group text-center">
                                <div class="col-sm-12 col-md-offset-2 ml-5">
                                    <div class="alert alert-info">
                                        If you invest <span id="lumpsumMonthlyInvestmentText">&#x20B9; **</span> per month for <span id="lumpsumYearsInvestmentText">**</span> years @ <span id="lumpsumPercentText"></span>% P.A expected rate of return, you will accumulate <span id="lumpsumTotInvestmentText">&#x20B9; **</span> at the end of the <span id="lumpsumEndYearText">**</span><sup>th</sup> year.
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <label class="control-label col-sm-7 text-right" for="">life insurance premium paid for self, spouse and children</label>
                        <div class="col-sm-4">
                    ...
                    <div class="row form-group">
                     ...
                     <div class="row form-group">
                        ...
                        <div class="col-sm-12 text-center">
                            <input type="button" name="" id="taxCheckBtn" value="Check Tax" class="btn add_btn btn-sm">
                            <input type="reset" value="Recompute" class="btn btn-default btnsize">
                        </div>
                    </div>
                </div>

                <div class="modal-footer">
                    <div class="row"><h6>Output</h6></div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row form-group">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">    
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 text-center">
                            <input type="button" name="" class="btn add_btn btn-sm" value="Check Fixed Deposit" id="fdCheckBtn">
                            <input type="reset" value="Recompute" class="btn btn-default btnsize">
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 text-center">
                            <input type="button" class="btn add_btn btn-sm" id="rdCheckBtn" name="" value="Check RD" placeholder="">
                            <input type="reset" value="Recompute" class="btn btn-default btnsize"> 
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 text-center">
                            <input type="button" class="btn add_btn btn-sm" id="homeLoanCheck" name="" placeholder="" value="Check Home Loan" required="">
                            <input type="reset" value="Recompute" class="btn btn-default btnsize"> 
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 text-center">
                            <input type="button" class="btn add_btn btn-sm" id="carLoanCheck" name="" placeholder="" value="Check Car Loan" required="">
                            <input type="reset" value="Recompute" class="btn btn-default btnsize"> 
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 text-center">
                            <input type="button" class="btn add_btn btn-sm" id="perLoanCheck" name="" placeholder="" value="Check Personal Loan">
                            <input type="reset" value="Recompute" class="btn btn-default btnsize"> 
                        </div>
                    </div>
                </div>  
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 text-center">
                            <input type="button" class="btn add_btn btn-sm" id="ppfCheck" name="" value="Check PPF">
                            <input type="reset" value="Recompute" class="btn btn-default btnsize">
                        </div>
                    </div>
                </div>
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-12 text-center">
                            <input type="button" name="" class="btn add_btn btn-sm" id="npsCheckBtn" value="Check NPS">
                            <input type="reset" value="Recompute" class="btn btn-default btnsize">
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 text-center">
                            <input type="button" class="btn add_btn btn-sm" id="ssyCheck" name="" value="Check SSY">
                            <input type="reset" value="Recompute" class="btn btn-default btnsize">
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 text-center">
                            <input type="button" class="btn add_btn btn-sm" id="HRA_Check" name="" value="Check">
                            <input type="reset" value="Recompute" class="btn btn-default btnsize">
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 text-center">
                            <input type="button" class="btn add_btn btn-sm" id="checksipInsBtn" value="Check SIP Installment" name="">
                            <input type="reset" value="Recompute" class="btn btn-default btnsize">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row form-group">
                                <label class="control-label col-sm-6 text-right" for="">Monthly SIP Amount to be invested to reach your goal</label>
                                <div class="col-sm-4">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form id="calData">
                ...
                <div class="modal-body">
                    <div class="row" id="oldnewForm">
                        <div class="col-lg-6 col-12" style="border-right: 1px dashed #d33633;">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <style type="text/css">
                        ...
                        body .container { min-width: 500px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"; }
                        body .clearfix:after { content: ""; display: table; clear: both; }
                        body .left { float: left; }
                        body .right { float: right; }
                        body .helper { height: 100%; }
                        header { height: 80px; padding: 0px 5px 0; }
                        ...
                        section .details { min-width: 500px; margin-bottom: 15px; padding: 10px 35px; background-color: #2A8EAC; color: #ffffff; margin-top:50px; }
                        ...
                        section .table-wrapper:before { content: ""; display: block; position: absolute; top: 33px; left: 30px; width: 90%; height: 100%; z-index: -1; }
                        section table { width: 100%; margin-bottom: -20px; table-layout: fixed; }
                        .align-middle { text-align: center; font-weight: 600; text-transform: uppercase; }
                        .align-left { text-align: left; font-weight: 600; text-transform: uppercase; }
                        .align-right { text-align: right; font-weight: 600; text-transform: uppercase; }
                        section table tbody tr td { padding: 10px 5px; background: #F3F3F3; text-align: right; }
                        footer .company-info { color: #BDB9B9; text-align:center; }
                        footer .company-info .title { margin-bottom: 5px; color: #2A8EAC; font-weight: 600; font-size: 2em; }
                        footer .company-info .line { display: inline-block; height: 9px; margin: 0 4px; border-left: 1px solid #2A8EAC; }
                    </style>
                    <header class="clearfix">
                        <div class="container" >
                            <div class="company-info">
                                <img class="logo" src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme_new; ?>img/black-logo.png" alt=""/>
                    ...
                    <section>
                        ...
                        <p id="oldNewResultFooter" class="oldP" style="text-align: center">This is computer generated report and conclusion is based on minimum information captured, provided by the user and the same can be consulted with an expert to validate the same.</p>
                    </section>
            ...
            <div class="row" id="userDetailsCalOldNew">
                <div class="col-xl-12">
                    <form method="POST" id="userData" action="<?= $CONFIG->siteurl; ?>__lib.htmlPages/__postLoginPages/pay/paymentrequest.php" >
                        <h4 class="modal-title">PAYMENT MODE (INR 99/-)</h4>
                        <p class="oldP">Please fill in this form  for completion of payment.</p>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <button type="button" value='action' name='action' class="boxed_btn boxed_btn_bg submit_calc" id="paymode" style="float: right;">Calculate</button>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6">
                    <div class="contact_form_info ">
                        <div class="section_title mb-40"><h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">Subscribe to our newsletter </h3></div>
                        <form action="<?= $CONFIG->siteurl; ?>ajax-request/ajax_response.php?action=contactushome&subaction=submit" method="POST" id="subscriptionForm" class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            <div class="row">
                                <div class="col-xl-12">
                                    <label class="form-label">Name<span class="required">*</span></label>
                                    <input name="formname" class="formname" autocomplete="off" type="text" id="formname">
                                </div>
                                <div class="col-xl-12">
                                    <label class="form-label">Email<span class="required">*</span></label>
                                    <input name="formemail" class="formemail" autocomplete="off" type="email" id="formemail">
                                </div>
                                <div class="col-xl-12">
                                    <label class="form-label">Mobile Number<span class="required">*</span></label>
                                    <input name="formnumber" class="formnumber" autocomplete="off" type="tel" id="formnumber">
                                </div>
                                <div class="col-xl-12">
                                ...
                                <div class="col-xl-12 text-center">
                                    <button class="btn login_btn btn-lg" type="submit" id="subscription">Subscribe</button>
                                </div>
                            </div>
                        </form>
                        <div id="contactresponsehome" class="orange text-center"> </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="contact_thumb2 wow fadeInRight" data-wow-duration="1s" data-wow-delay=".2s">
                        <div class="thumb_inner text-center">
                            <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme_new; ?>img/newsletter.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <div class="modal-body ">
                        <div class="login_form">
                            <div class="login_heading"><h3>Build Wealth</h3></div>
