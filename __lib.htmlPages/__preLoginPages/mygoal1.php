	...
	<div class="mainbg">
		<div class="row mb-4">
			<div class="col-md-5">
				...
				<form class="register_form" method="post" name="eventForm1" id="eventForm1" enctype="multipart/form-data" >
		...
		<div class="row">
			<div class="col-md-4 col-md-4 col-12">
				<div class="contest_period">
					...
					<h6>28th&nbsp;April&nbsp;to&nbsp;10th&nbsp;MAY&nbsp;2021</h6>
				</div>
			</div>
...
<div class="textDataCamp">
	<div class="container">
		...
		<div class="row">
			<div class='col-3 border-right'><div class='description-block'><span class='description-text'>Registration open till</span><h5 class='description-header'>10th May</h5></div></div>
			<div class='col-3 border-right'><div class='description-block'><span class='description-text'>1st Round Result</span><h5 class='description-header'>15th May</h5></div></div>
			<div class='col-3 border-right'><div class='description-block'><span class='description-text'>Video Plan submission by</span><h5 class='description-header'>25th May</h5></div></div>
			<div class='col-3'><div class='description-block'><span class='description-text'>Final Results by</span><h5 class='description-header'>1st June</h5></div></div>
		</div>
		<br><br>
	</div>
</div>