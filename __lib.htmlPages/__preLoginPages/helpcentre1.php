...
<h4>How to file income tax</h4>
<div class="tab">
        <input type="radio" id="rd1" name="rd">
        <label class="tab-label" for="rd1">How to Register with Income Tax Department to filing of Income Tax Returns for the first time?</label>
        <div class="tab-content" id="howtofileincometax">
           How to Register with Income Tax
							Department to filing of Income Tax Returns for the first time?</label>
						<div id="howtofileincometaxcontentsblock">
								...
								<li>Open the Income tax e filing Website by clicking on the
									...
									<br>
									You will be taken to the Income tax portal; Click on
										Register Yourself which is on the right hand corner on the
										face of the website.<br>
								</li>
								...
								<li>You will be taken to the next page which shows you to select
									the user type :
									Select Individual and click on Continue.<br>
								</li>
							...
							<img
								...
								<li>Enter Your Basic Details :
									Only the fields marked with asterisk (*) are mandatory; all
										the details whether or not mandatory, should be as per the
										details of PAN card.<br>
									Enter required details and click continue<br>
								</li>
							...
							Here the registration details page should be displayed and you
								have to enter all the personal details:<br>
							...
							Make sure that you remember your password or at least one of
								the secret question answers as they are useful for password
								reset if in case you forget the password.<br>
							...
							<img
								...
								<li>
									...
									<br>
									Enter all the details in fields marked with asterisk (*):<br>
...
<div class="tab">
        ...
        <label class="tab-label" for="rd2">What if I have given wrong Mail ID or Mobile Number while registering?</label>
        <div class="tab-content" id="howtofileincometax">
      ...
      <div class="tab">
        ...
        <label class="tab-label" for="rd3">I am a Non- Resident User. I do not have a Mobile Number in India. How do I register in e-Filing?</label>
        <div class="tab-content" id="howtofileincometax">
        ...
        <label class="tab-label" for="rd4">I'm not able to register, as I get an error message “Invalid PAN Details”. What should I do?</label>
        <div class="tab-content" id="howtofileincometax">
        ...
        <label class="tab-label" for="rd5">What is tax deducted at source?</label>
        <div class="tab-content" id="howtofileincometax">
         For quick and efficient collection of taxes, the Income-tax Law has incorporated a system of deduction of tax at the point of generation of income. This system is called as “Tax Deducted at Source”, commonly known as TDS.<br>
Under this system tax is deducted at the origin of the income. Tax is deducted by the payer and is remitted to the Government by the payer on behalf of the payee.<br>
The provisions of deduction of tax at source are applicable to several payments such as salary, interest, commission, brokerage, professional fees, royalty, contract payments, etc.<br>
In respect of payments to which the TDS provisions apply, the payer has to deduct tax at source on the payments made by him and he has to deposit the tax deducted by him to the credit of the Government.  
        ...
        <label class="tab-label" for="rd6">What is the difference between PAN and TAN?</label>
        <div class="tab-content" id="howtofileincometax">
...
PAN cannot be used for TAN, hence, the deductor has to obtain TAN, even if he holds PAN.<br>
However, in case of TDS on purchase of land and building (as per section 194-IA), the deductor is not required to obtain TAN and can use PAN for remitting the TDS.  
        ...
        <label class="tab-label" for="rd7">What is the validity of PAN?</label>
        <div class="tab-content" id="howtofileincometax">
           PAN obtained once is valid for life-time of the PAN-holder throughout India.<br>
It is not affected by change of address or change of Assessing Officer etc.<br>
However, any change in the PAN database (i.e. details provided at the time of obtaining PAN) should be intimated to the Income Tax Department by furnishing the details in the form for “Request For New PAN Card Or/ And Changes or Correction in PAN Data”.
        ...
        <label class="tab-label" for="rd8">Can a person hold more than one PAN?</label>
        <div class="tab-content" id="howtofileincometax">
         A person cannot hold more than one PAN. If a PAN is allotted to a person, then he cannot apply for obtaining another PAN.<br> A penalty of Rs. 10,000/- is liable to be imposed under Section 272B of the Income-tax Act, 1961 for having more than one PAN.<br>
If a person has been allotted more than one PAN then he should immediately surrender the additional PAN card(s).  
        ...
        <label class="tab-label" for="rd9">Is it mandatory to file return of income after getting PAN?/ Who are required to file Return?</label>
        <div class="tab-content" id="howtofileincometax">
         
 It is not mandatory to file return of income after getting PAN. <br>
 Return is to be filed only if you are liable to file return of income as under :<br>
...
<li>In respective of a firm or a company, Return of Income needs to be filed irrespective of the income/loss of the firm or company during the financial year.</li>
        ...
        <label class="tab-label" for="rd10">If I lost my PAN card what should I do?</label>
        <div class="tab-content" id="howtofileincometax">
           If the PAN card is lost then you can apply for duplicate PAN card by submitting the Form for "Request for new PAN Card or/ and Changes or Correction in PAN Data" and a copy of FIR may be submitted along with the form.<br>
If the PAN card is lost and you don't remember your PAN, then in such a case, you can know you PAN by using the facility of "Know Your PAN" provided by the Income Tax Department. This facility can be availed of from the website of Income Tax Department - incometaxindia.gov.in<br>
...
<div class="tab">
  <input type="radio" id="rd11" name="rd">
        <label class="tab-label" for="rd11">How to reset the password for Income Tax login?</label>
        <div class="tab-content" id="resetpassworditcontentsblock">
           There are four ways to reset a password for a registered user:<br>
...
<li>Using DSC</li>
 ...
 For all the four Processes we have the following steps as common:<br>
...
<li>Then you will be taken to next page select the appropriate option suitable for you and follow the steps given below;</li>
 ...
 <strong>1. Answer secret Question:</strong> <br>
 If you select the option of Answering secret question you have to follow the below steps:<br>
...
<li>Once the password has been changed a success message will be displayed. You can login with new password.</li>
 ...
 <strong>2. Using OTP (PINs):</strong> <br>
 If you select the option of Using OTP(PINs) you have to follow the below steps:<br>
...
<li>On success a message will be displayed, you can login with new password after the time specified in Success message displayed.</li>
 ...
 <strong>3. Using Aadhaar OTP:</strong> <br>
...
<li>Once the password has been changed a success message will be displayed. User can login with new password.</li>
 ...
 <strong>4. Using DSC:</strong> <br> 

 
You have two options in this:<br>
...
<div class="tab">
  <input type="radio" id="rd12" name="rd">
        <label class="tab-label" for="rd12">How to Login to e-filing using Net Banking? / How to Change Password using Net Banking?</label>
        <div class="tab-content" id="howtofileincometax">
...
<div class="tab">
  <input type="radio" id="rd13" name="rd">
        <label class="tab-label" for="rd13">What is the last date for posting the ITR V signed Document?</label>
        <div class="tab-content" id="howtofileincometax">
...
<div class="tab">
  <input type="radio" id="rd14" name="rd">
        <label class="tab-label" for="rd14">What is the Address for sending the ITR V signed copy?</label>
        <div class="tab-content" id="howtofileincometax">
          The ITR V Signed copy has to be sent Speed Post or Ordinary Post&nbsp;without Folding&nbsp;- at the following address:<br>

<strong>Centralized Processing Centre (CPC),</strong><br>
<strong>Income Tax Department,</strong><br>
<strong>Bengaluru- 560500</strong><br>
<strong>Karnataka</strong><br> 
        </div> </div>

<div class="tab">
  <input type="radio" id="rd15" name="rd">
        <label class="tab-label" for="rd15">What is the Password to open ITR V Document?</label>
        <div class="tab-content" id="howtofileincometax">
...
<div class="tab">
  <input type="radio" id="rd16" name="rd">
        <label class="tab-label" for="rd16">Can I send more than one ITR V documents in one Envelope?</label>
        <div class="tab-content" id="howtofileincometax">
...
<div class="tab">
  <input type="radio" id="rd17" name="rd">
        <label class="tab-label" for="rd17">What is the password to open Form 26AS?</label>
        <div class="tab-content" id="howtofileincometax">
 
The Password to open Form 26AS is your date of birth in the format-&nbsp;<em>ddmmyyy</em>&nbsp;(e.g. If your Date of birth is&nbsp;<strong><em>21-01-1990</em></strong>&nbsp;then the password to open 26 AS will be&nbsp;<strong><em>21011990</em></strong>)&nbsp;
 
        </div> </div>

<div class="tab">
  <input type="radio" id="rd19" name="rd">
        <label class="tab-label" for="rd19">When we can get the refund?</label>
        <div class="tab-content" id="howtofileincometax">
       
 Once the return is filed online and it is e-verified or ITR V is sent to the department, the return will be processed, you will generally get the refund amount within 2-6 months after filing the return of income.<br>
 You can check the refund status by using the following link, giving the PAN number and relevant Assessment year:&nbsp;<a href="https://tin.tin.nsdl.com/oltas/refundstatuslogin.html" target="_blank">https://tin.tin.nsdl.com/oltas/refundstatuslogin.html</a> 
 
        </div> </div>

        <div class="tab">
  <input type="radio" id="rd20" name="rd">
        <label class="tab-label" for="rd20">How to do e-verification?</label>
        <div class="tab-content" id="howtofileincometax">
         Income Tax Return filed by the taxpayer is not treated as
								...
								e-Verification. <br>
							 If the return has been e-verified then there is no need to
								send ITR V to CPC. <br>
							 You can e-verify your return using any of the following
								options: <br>
							<ol>
							 ...
							 In case of return already filed, you can e verify the return
							...
							<img
							 ...
							 After you click no the e-verify Return you will get four
								options: <br>
							 ...
							 <br>
							 Here in this option you will get three options: <br>
  ...
  <input type="radio" id="rd21" name="rd">
        <label class="tab-label" for="rd21">Who are liable to pay advance tax?
</label>
        <div class="tab-content" id="howtofileincometax">
  ...
  <input type="radio" id="rd22" name="rd">
        <label class="tab-label" for="rd22">Exemptions in Advance tax Payment:</label>
        <div class="tab-content" id="howtofileincometax">
  ...
  <input type="radio" id="rd23" name="rd">
        <label class="tab-label" for="rd23">What are the Due dates for payment of advance tax?</label>
        <div class="tab-content" id="howtofileincometax">
           <p>Advance tax is to be paid in different instalments. The due dates for payment of different instalments of advance tax are as follows:</p>
...
<td width="114">
<p><strong>By 15<sup>th</sup>&nbsp;June</strong></p>
</td>
<td width="114">
<p><strong>By 15<sup>th</sup>September</strong></p>
</td>
<td width="118">
<p><strong>By 15th December</strong></p>
</td>
<td width="122">
<p><strong>By 15<sup>th</sup>&nbsp;March</strong></p>
</td>
</tr>
<tr>
<td width="187">
<p><strong>All assesses</strong></p>
<p><strong>(except those who opted for presumptive taxation)</strong></p>
</td>
<td width="114">
...
<tr>
<td width="187">
<p><strong>Taxpayers who opted for presumptive taxation</strong></p>
</td>
<td width="114">
<p>Nil</p>
</td>
...
<p>Advance tax</p>
  ...
  <input type="radio" id="rd24" name="rd">
        <label class="tab-label" for="rd24">What is the mode of payment of advance tax?</label>
        <div class="tab-content" id="howtofileincometax">
           A company and a person whose are required to get audited shall pay taxes only through the electronic payment mode using the internet banking facility of the authorized banks.<br>
...
<h4 id="paytaxonline" >Pay Tax online</h4>
       <div class="tab">
  <input type="radio" id="rd33" name="rd">
        <label class="tab-label" for="rd33" >How to pay tax online</label>
        <div class="tab-content" id="paytaxonline">
This Payment procedure is for payment of taxes online<br>
							...
							<br>
							<img
								src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/view26AS1.png"><br>
							...
							<br>
							You will be displayed the following screen, fill in the
								details as required and click on proceed<br>
							<img
								src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/view26AS2.png">
							
								<strong>Step 3:</strong><br>
							<br>
							After clicking on proceed verify the details as shown on the
								screen and fill in the details of taxes to be paid and proceed
								for payment<br>
							
								<strong>Step 4:</strong><br>
							<br>
							After payment download the challan (OR) make the print screen
								picture of challan details.<br>
        </div></div>


<h4 id="viewform26as" >How to view form 26AS</h4>
       <div class="tab">
  <input type="radio" id="rd34" name="rd">
        <label class="tab-label" for="rd34" >How to view form 26AS</label>
        <div class="tab-content" id="viewform26as">
The following details have been provided in 26AS statement:<br>
							...
							This statement is presented yearly, which reflects the
								transaction of the concerned year.&nbsp;<br>
							...
							<br>
							For downloading PDF file, first view as HTML and then click on
								export to PDF.<br>
							</div></div>
<h4 id="refundstatus" >Knowing Refund Status</h4>
       <div class="tab">
  <input type="radio" id="rd35" name="rd">
        <label class="tab-label" for="rd35" >How to check Refund Status?</label>
        <div class="tab-content" id="refundstatus">
							...
							<br>
							Enter your PAN; Select the Assessment Year for which you want
								to check the refund status&nbsp; and enter the text as shown in
								the image<br>
							<img
								src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/refundstatus1.png"><br>
							
								<strong>Step 3: </strong>
							<br>
							If the refund is processed by the Assessing Officer the status
...
<h4 id="everify" >How to e-Verify</h4>
       <div class="tab">
  <input type="radio" id="rd36" name="rd">
        <label class="tab-label" for="rd36" >How to e-verify the Return?</label>
        <div class="tab-content" id="everify">
Income Tax Return filed by the taxpayer is not treated as
								valid until it is verified by the taxpayer. In the existing
								process, taxpayer can verify the return using Digitally Signed
								Certificate (DSC) or by sending signed ITR-V to CPC. As per Rule
							...
							In case of return already filed, you can e verify the return
								...
								e-verify return<br>
							<img
								src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/everifyreturn1.png"><br>
							After you click no the e-verify Return you will get four
								options:<br>
...
<h4 id="file26qb" >File 26 QB (TDS on Sale of Property)</h4>
       <div class="tab">
  <input type="radio" id="rd40" name="rd">
        <label class="tab-label" for="rd40" >What is TDS on Sale of Property and when this should be deducted?</label>
        <div class="tab-content" id="file26qb">
As per Finance Bill of 2013, TDS is applicable on sale of immoveable property where in the sale consideration of the property exceeds or is equal to Rs.50,00,000 (Rupees Fifty Lakhs).
Sec 194 IA of the Income Tax Act, 1961 states that for all transactions with effect from June 1, 2013, Tax @ 1% should be deducted by the purchaser (Buyer) of the property at the time of making payment of sale consideration.
        </div>
    </div>

    <div class="tab">
  <input type="radio" id="rd41" name="rd">
        <label class="tab-label" for="rd41" >Some important points</label>
        <div class="tab-content" id="file26qb">

<li>Deduct tax @ 1% from the sale consideration</li>
<li><strong><em>TDS of 1% should be deducted on amount&nbsp;<u>excluding of taxes.</u></em></strong></li>
<li>As per the CBDT notification no. 30/2016 dated April 29, 2016, the due date of payment of TDS on transfer of immovable property is&nbsp;<strong><u>thirty days</u></strong>&nbsp;from the end of the month in which the deduction is made.</li>
<li>Due date of filing will be by 7th of the next month of the month for which transaction is reported. If filing has not been done with in time then Late filing fee u/s 234E will be charged @ Rs.200/- per day.</li>
<li>Due date of TDS deposit will be by 7th of the next month of the month for which transaction is reported. If TDS is not deposited with in time then Late Payment Interest u/s 200A and &nbsp;u/s 154 read with Sec 201(1A) will be charged @1.5% per month on TDS amount.</li>
<li>Do not commit any error in quoting the PAN or other details in the online Form as there is no online mechanism for rectification of errors. For the purpose of rectification you are required to contact Income Tax Department.</li>
<li>While completing the Online form, please note the following points:-

<li>Fields marked with * are mandatory</li>
<li>&nbsp;Do not enter double quotes (&ldquo; ") in any of the fields.</li>

</li>
<li>TDS amount as per Form 26QB should be entered in the field &lsquo;Basic Tax&rsquo; (Income Tax) on the Bank&rsquo;s web-portal</li>
<li>TDS certificate (Form 16B) will be based on &ldquo;Basic Tax&rdquo; (Income Tax) only</li>
<li>Taxpayer/ Buyer are advised to save the Acknowledgement Number for downloading the Form 16B from TRACES website</li>
<li>TDS certificate (Form 16B) will be available for download from the TRACES website after at least 2 days of deposit of tax amount at the respective Bank.</li>
<li>Click on View Acknowledgment Number under TDS on Property by providing the relevant details for retrieving the Acknowledgment Number</li>

&nbsp;Link -&nbsp;<a href="https://www.tin-nsdl.com/faqs/tds-on-sale-of-property/TDS-Introduction.html" target="_blank">https://www.tin-nsdl.com/faqs/tds-on-sale-of-property/TDS-Introduction.html</a><br>
        </div>
    </div>

    <div class="tab">
  <input type="radio" id="rd42" name="rd">
        <label class="tab-label" for="rd42" >Procedure for Filing of Form 26QB</label>
        <div class="tab-content" id="file26qb">

								<strong><u>STEP -1 </u></strong>
							<br>
							By clicking on the link, the below page will be displayed.
								Click on Form 26QB as highlighted in the image.<br>
							
								Link - <a
									href="https://onlineservices.tin.egov-nsdl.com/etaxnew/tdsnontds.jsp" target="_blank">https://onlineservices.tin.egov-nsdl.com/etaxnew/tdsnontds.jsp</a>
							<br>
							<img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qb1.png"><br>
							
								<strong><u>STEP -2</u></strong>
							<br>
							By selecting the Form 26QB the following page will be
								displayed, fill all the mandatory fields and additional fields
								as required with help of hints given.<br>
							<img
								src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qb2.png"><br>
							<img
								src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qb3.png"><br>
							<img
								src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qb4.png"><br>
							<img
								src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qb5.png"><br>
							After filling all the details click on proceed, it will
								...
								Regarding mode of payment of taxes has been mentioned below.<br>
							<img
								src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qb6.png"><br>
							...
							<br>
							<img
								src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qb7.png"><br>
...
<strong>List of Banks for Payment through Debit Card</strong><br>
</td>
</tr>
<tr>
...
<h4 id="file26qc" >File 26 QC (TDS on Rent of Property)</h4>
       <div class="tab">
  <input type="radio" id="rd45" name="rd">
        <label class="tab-label" for="rd45" >What is TDS on Rent of Property and who is reasonable to deduct?</label>
        <div class="tab-content" id="file26qc">
 As per Finance Act, 2017, &ldquo;TDS on Rent&rdquo; under section 194-IB is liable to be deducted by Individuals or HUFs (other than an individual who are not liable for Tax Audit u/s 44AB) who is paying to a resident monthly rent exceeding Rs.50,000. Section 194-IB of the Income Tax Act, 1961 states that for all the transactions with effect from June 1, 2017, tax @5% should be deducted by the Tenant/ Lessee/ Payer of the property at the time of making payment of rent (to Landlord / Lessor/ Payee). Tax so deducted should be deposited to the Government Account through any of the authorized bank branches.<br>
<strong><u>Applicability:</u></strong><br>
Individual or HUF who are not liable for tax audit under section 44AB.<br>
<strong><u>Limit &amp; Rate</u></strong><u>:</u><br>
Rent of Rs. 50,000 for a month or part of the month @ 5%.<br>
Note -&nbsp;<strong>This section does not applies to those rent which are covered under Section 194-I.</strong><br>
<strong><u>Highlights of Section 194-IB</u></strong><br>
<strong>No need to obtain TAN</strong>&nbsp;- Under this section, Tax payer need not to obtain TAN.<br>
<strong>Deduction, once in a year</strong>&nbsp;- Under this section, Tax payer is required to deduct tax at source only once in a financial.<br>
<strong>Time of deduction</strong>&nbsp;- The tax should be deducted at the time of credit or payment (whichever is earlier) of rent for the last month of the tax year or last month of tenancy if the property is vacated during the year, as applicable.<br>
<strong><em><u>Example</u></em></strong>&nbsp;&ndash; Mr A is a tenant of a property for which he is paying rent of Rs.60,000/- per Month and Mr A is not liable to tax audit u/s 44AB. Mr A is residing in the same property for whole Financial year 2018-19(April&rsquo;18 to March&rsquo;19).<br>
In the present case Mr A has to deduct TDS @ 5% while paying the rent for the month of March&rsquo;19. The total amount of TDS to be deducted is Rs.7,20,000(60,000*12 = 7,20,000) X 5% is Rs.36,000/- .<br>
If the Rent/Lease agreement has been completed in between the Financial year, TDS should be deducted in last month of tenancy if the property is vacated during the year.<br>
&nbsp;<br>
<strong><u>Comparison between 194-IA &amp; 194-IB</u></strong><br>
<table border="1" width="100%">
<tbody>
<tr>
<td width="205">
<strong><u>Basis</u></strong><br>
</td>
<td width="205">
<strong><u>194 - IA</u></strong><br>
</td>
<td width="205">
<strong>194&nbsp;&nbsp;&nbsp;</strong><strong><u>- IB</u></strong><br>
</td>
</tr>
<tr>
<td width="205">
...
<td width="205">
i) Every person paying rent (except individual &amp; HUF)<br>
ii) Individual &amp; HUF if doing business and covered in tax audit<br>
</td>
<td width="205">
Every Individual &amp; HUF not covered in 194-I<br>
</td>
</tr>
<tr>
<td width="205">
...
<td width="205">
&nbsp;<br>
Rs. 1,80,000 Per annum<br>
</td>
<td width="205">
Rs. 50,000 per month or part of the month during financial year<br>
</td>
</tr>
<tr>
<td width="205">
...
<td width="205">
TAN is not required, PAN is enough.<br>
</td>
</tr>
</tbody>
</table>
    ...
    <div class="tab">
  <input type="radio" id="rd46" name="rd">
        <label class="tab-label" for="rd46" >Some important points</label>
        <div class="tab-content" id="file26qc">
...
<li>If the Landlord / Lessor/ Payee is a non-resident, liability to deduct TDS arises under section 195 of the Income-tax Act, 1961</li>
    ...
    <div class="tab">
  <input type="radio" id="rd47" name="rd">
        <label class="tab-label" for="rd47" >Procedure for Filing of Form 26QC</label>
        <div class="tab-content" id="file26qc">

<strong>STEP -1</strong><br>
By clicking on the link, the below page will be displayed. Click on Form 26QC as highlighted in the image.<br>
Link - <a href="https://onlineservices.tin.egov-nsdl.com/etaxnew/tdsnontds.jsp" target="_blank">https://onlineservices.tin.egov-nsdl.com/etaxnew/tdsnontds.jsp</a><br>
                            <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qc1.png"><br>
                            
                            <strong>STEP -2 </strong><br>
By selecting the Form 26QC the following page will be displayed, fill all the mandatory fields and additional fields as required with help of hints given.<br>
                            <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qc2.png"><br> 
                            <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qc3.png"><br>
                            <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qc4.png"><br>
                            <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qc5.png"><br>
                            
                            After filling all the details click on proceed, it will navigate to confirmation page. Once you had confirmed all the details 26QC will be generated and take print of the Form 26QC. Regarding mode of payment of taxes has been mentioned below.<br>
                            <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qc6.png"><br>
							...
							<br>
							<img
								src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/form26qc7.png"><br>
							
								ii) <em><u>Payment through Debit card</u></em> -&nbsp; The
								following is the list of banks accepted for Debit card paymenet
							<br>
							<table width="100%" style="height: 101px; width: 697px;" border="1">
<tbody>
<tr>
<td style="width: 675px;" colspan="5">
<strong>List of Banks for Payment through Debit Card</strong><br>
...
<h4 id="mandatoryfile" >Who should mandatorily file their Income Tax Returns</h4>
       <div class="tab">
  <input type="radio" id="rd48" name="rd">
        <label class="tab-label" for="rd48" >Who are required to file Return?/ Is it mandatory to file return of income after getting PAN?</label>
        <div class="tab-content" id="mandatoryfile">
  It is not mandatory to file return of income after getting
								PAN. <br>
							 Return is to be filed only if you are liable to file return of
								income as under : <br>
...
<h4 id="ifdontfiletax" >What happens if we don't file the return within due date</h4>
       <div class="tab">
  <input type="radio" id="rd49" name="rd">
        <label class="tab-label" for="rd49" >What happens if we don’t file the return within the due date?</label>
        <div class="tab-content" id="ifdontfiletax">
   A new section 234F has been inserted in Income Tax Act, 1961
								with effect from Assessment Year 2018-19 (Financial Year
								2017-18).<br>
							 &nbsp;<br>
							 Under this section, fee/penalty is levied if the Income-tax
							...
							<table border="1" width="100%">
								<tbody>
									...
									<tr>
										...
										<td width="366">
											 Return filed any time after due date<br>
										</td>
...
<h4 id="iftaxliability" >Can you still file your Income Tax Return if there is any tax liability</h4>
       <div class="tab">
  <input type="radio" id="rd50" name="rd">
        <label class="tab-label" for="rd50" >Can you still file your Income Tax Return if there is any tax liability ?</label>
        <div class="tab-content" id="iftaxliability">
...
<h4 id="incomebelow" >If my income is below the taxable limits, can I still file my Tax Returns</h4>
       <div class="tab">
  <input type="radio" id="rd51" name="rd">
        <label class="tab-label" for="rd51" >If my income is below the taxable limits, can I still file my Tax Returns</label>
        <div class="tab-content" id="incomebelow">
Yes you can still file your income tax return but it is not mandatory
        </div>
    </div>


    <h4 id="linkaadharpan" >Steps to link Aadhaar with PAN</h4>
       <div class="tab">
  <input type="radio" id="rd52" name="rd">
        <label class="tab-label" for="rd52" >Steps to link Aadhaar with PAN </label>
        <div class="tab-content" id="linkaadharpan">
...
<li>If Your Aadhaar is already linked with PAN with Same name and want to verify the correctness, the alert message will be displayed on to the screen "Your PAN is already linked to the Aadhaar&nbsp; Number"</li>
        ...
        <h4 id="pendingrefunds" >How can I get pending refunds?</h4>
        <div class="tab">
  <input type="radio" id="rd25" name="rd">
        <label class="tab-label" for="rd25" >How can I get pending refunds?</label>
        <div class="tab-content" id="pendingrefunds">
          Step 1: Click on this link https://tin.tin.nsdl.com/oltas/refundstatuslogin.html, this will take you to NSDL website.<br>                          
                          Step 2:Enter your PAN; Select the Assessment Year for which you want to check the refund status and enter the text as shown in the image<br>
                                <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/refund1.png"><br>
                            Step 3:&nbsp;If the refund is processed by the Assessing Officer the status of the refund will be shown, if the refund is not processed then this below screen will be displayed that means you have to wait for some more time.<br> 
                                <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/refund2.png"> 
        </div> </div>
        <div class="tab">
  <input type="radio" id="rd18" name="rd">
        <label class="tab-label" for="rd18">Is your refund pending for long time!! Don’t worry we are here to help you.</label>
        <div class="tab-content" id="pendingrefunds">
         Follow few simple steps we will help you to get the refund&nbsp;<br>
                            <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/refund3.PNG"> 
        </div> </div>

 <h4 id="defectivenotice" >I have recevied a defective Notice. What should I do?</h4>


        <div class="tab">
  <input type="radio" id="rd26" name="rd">
        <label class="tab-label" for="rd26">How to reply for Notice u/s 139 (9) ?</label>
        <div class="tab-content" id="defectivenotice">
          Notice u/s 139(9) is basically intimation from the Income Tax Department for the Income tax return filed for a financial year being defective due to following common reasons:<br>
...
<li>In order to clear the defects in the original return filed i.e. in response to the notice sent by the department u/s 139(9), the assessee is required to file response within 15 days of the receipt of intimation or within such other time as extended by the AO on a written request filed for the same. For filing the response one should mention in the return the section under which the return is being filed and the communication reference number which is already there on the intimation given by the department.</li>
  ...
  <input type="radio" id="rd27" name="rd">
        <label class="tab-label" for="rd27">What are the consequences if You don’t reply in 15 days?</label>
        <div class="tab-content" id="defectivenotice">
           If you don&rsquo;t reply with in specified time for the notice under section 139(9), your retrun will be considered as invalid that means it will treated the return is not filed at all.
        </div> </div>
        <div class="tab">
  <input type="radio" id="rd28" name="rd">
        <label class="tab-label" for="rd28">Received a notice from the income tax department!! Don’t worry we are here to help you.</label>
        <div class="tab-content" id="defectivenotice">
         Talk to our experts, we will help you to resolve the notice<br>
                            <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/notice2.PNG">  
        </div> </div>


 <h4 id="othernotice" >Answering notices and intimations</h4>


        <div class="tab">
  <input type="radio" id="rd29" name="rd">
        <label class="tab-label" for="rd29">Intimation u/s 143(1) can be considered as Assessment?</label>
        <div class="tab-content" id="othernotice">
 ...
 <u>Case Law: TATA AIG GENERAL INSURANCE PVT LTD Vs DCIT ITAT (Mumbai)- ITA No.968 (MUM)2015.</u><br>
 <strong>Assessment under section 143(1)</strong><br>
 ...
 <strong>Scope of assessment under section 143(1)</strong><br>
...
<li>Assessment under section 147, i.e., Income escaping assessment.</li>
 ...
 All the above mentioned notices are issued which leads to the given assessment proceedings. <br>    
        </div> </div>
        <div class="tab">
  <input type="radio" id="rd31" name="rd">
        <label class="tab-label" for="rd31">How to reply for Notice u/s 139 (9)?</label>
        <div class="tab-content" id="othernotice">
           Notice u/s 139(9) is basically intimation from the Income Tax Department for the Income tax return filed for a financial year being defective due to following common reasons:<br> 
 ...
 In order to clear the defects in the original return filed i.e. in response to the notice sent by the department u/s 139(9), the assessee is required to file response within 15 days of the receipt of intimation or within such other time as extended by the AO on a written request filed for the same. For filing the response one should mention in the return the section under which the return is being filed and the communication reference number which is already there on the intimation given by the department.<br>   
  ...
  <input type="radio" id="rd32" name="rd">
        <label class="tab-label" for="rd32">When can an assessee receive notice for scrutiny assessment u/s 147?</label>
        <div class="tab-content" id="othernotice">
       Notice for scrutiny assessment u/s 147 is issued u/s 148 if the Assessing Officer(AO) has reason to believe that any income has escaped assessment which should be chargeable to tax . The main objective of<br> 
...
In case the income which is escaped relates to any asset located outside India, notice can be issued upto 16 years from the end of the relevant assessment year.<br> 
...
<li>Where a return of income has been furnished by the assessee and on the basis of information or document received from the prescribed income-tax authority under section 133C(2), it is noticed by the Assessing Officer that the assessee has understated the income or has claimed excessive loss, deduction, allowance or relief in the return.</li>
  ...
  <input type="radio" id="rd44" name="rd">
        <label class="tab-label" for="rd44">Received a notice from the income tax department!! Don’t worry we are here to help you.</label>
        <div class="tab-content" id="othernotice">
         alk to our experts, we will help you to resolve the notice<br>
                            <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>helpcentreimg/notice2.png">    
        </div> </div>
...
<!-- 
        <div class="tab">
  <input type="radio" id="rd34" name="rd">
        <label class="tab-label" for="rd34"></label>
        <div class="tab-content" id="howtofileincometax">
           
        </div> </div> -->


    <!-- <div class="tab"> <input type="radio" id="rd1" name="rd">
    <label class="tab-label" for="rd1">
						...
						<div id="howtofileincometaxcontentsblock">
                         ...
                         <!--  <div class="tab">
    <input type="radio" id="rd2" name="rd">
    <label class="tab-label" for="rds">
						 What if I have given wrong Mail ID or
							Mobile Number while registering?</label>
						<div class="tab-content">
							<ul>
								<li>Click on the link given below it will take you to Income Tax
									Website:</li>
