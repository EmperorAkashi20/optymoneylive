            ...
            <div class="row">
               ...
               <?php
                  ...
                  while(list($offer_key,$offer_val) = each($fetch_offer_name)) {
                     ...
                     // print_r($offer_key);
               ?>
                  <button class="bordered_btn offer_id" data-valGroup="<?php echo $offer_val[offer_group]; ?>" data-val="<?php echo $offer_val[pk_offer_id]; ?>"><?php echo $offer_val[offer_name];?></button>
               <?php } } ?>
               </div>
            </div>
            <div class="row">
               <div class="col-12 col-md-4">
                  <div class="card border-0 shadow-none">
                     <div class="col-md-12">
                        <p class="title">FILTERS<a style="float:right;" href="#" id="clear_all">CLEAR ALL</a></p>
                     </div>
                  </div>
                                 ...
                                 <ul id="treeview" class="hummingbird-base">
                                    ...
                                    ?>
                                       <li>
                                          ...
                                          <label> <input id="category<?= $i; ?>" class="schm_type1" data-id="category<?= $i; ?>" value="<?php echo base64_encode($key); ?>" type="checkbox"> <?php echo str_replace("_"," ",$key);?></label>
                                          <ul style="margin-left: 40px;">
                                             <?php
                                                while(list($key1,$val1) = each($val)) {
                                                   while(list($key2,$val2) = each($val1)) {
                                             ?>
                                             <li><label> <input class="hummingbirdNoParent schm_type1" id="<?php echo base64_encode($val2[0]); ?>" value="<?php echo base64_encode($val2[0]); ?>" type="checkbox"> <?php echo ucwords(str_replace("_"," ",$val2[1]));?></label></li>
                                             <?php } } ?>
                                          </ul>
                                       </li>
                                    <?php } ?>
                     ...
                     <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                           ...
                           <div class="card-body">
                              ...
                              <button class="btn btn-lg btn-block btn-outline-danger" onclick="javascript:window.location='calculators.html'">Use them for Free</button>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                           ...
                           <div class="card-body">
                              ...
                              <button class="btn btn-lg btn-block btn-outline-danger" onclick="javascript:window.location='calculators.html#sipCal';" >Check it out now</button>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                           ...
                           <div class="card-body">
                              ...
                              <button class="btn btn-lg btn-block btn-outline-danger" onclick="javascript:window.location='calculators.html#lumpsumCal';" >Check it out now</button>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                           ...
                           <div class="card-body">
                              ...
                              <button class="btn btn-lg btn-block btn-outline-danger" onclick="javascript:window.location='all_product.html';">Check it out now</button>
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="goal-text">
            <div class="row">
               <div class="col-xs-12 col-sm-8 col-md-8">
                  <h2 class="text-center wow fadeInUp mb-90">PLAN A <span>GOAL</span></h2>
                  <div class="plans"><ul>
               ...
               <div class="col-xs-12 col-sm-4 col-md-4"><center><img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme; ?>img/target_icon.png" alt=""></center></div>
            </div>
         </div><!-- Blog Sec -->
      <!--</div>
   </section>
