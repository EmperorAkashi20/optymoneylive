				...
				<form class="register_form" action="<?= $CONFIG->siteurl; ?>ajax-request/ajax_response.php?action=par_reg&subaction=submit" method="post" name="eventForm" id="eventForm" enctype="multipart/form-data" >
					...
					<div class="form-group">
						<div class="upload-btn-wrapper">
							...
							<p class="text-center" style="font-size: 12px; color: #FFF; ">Note: Write your Goal on paper or add Sticker to your photo, make it as creative and upload when you are ready in the Profile section after login.</p>
						</div>
					</div>
					<div class="form-group">
