                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 text-center">
                            ...
                            <input type="reset" value="Recompute" id="sipRecompute" class="btn btn-default btnsize">
                        </div>
                    </div>
            ...
            <form class="form-horizontal" action="/action_page.php">
                <div class="modal-body">
                   ...
                   <div class="row form-group">
                        ...
                        <div class="col-sm-12 text-center">
                            <input type="button" class="btn btn-primary btnsize" value="Check Lumpsum" id="checkLumpsumBtn" name="">
