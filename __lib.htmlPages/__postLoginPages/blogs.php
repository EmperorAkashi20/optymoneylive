                              ...
                              <div class="col-xl-4 col-lg-4 col-12 mt-2 mb-3">
                                 ...
                                 <div class="card">
                                    ...
                                    <div class="card-footer text-muted text-center">
                                       <a href="?module_interface=<?php echo $commonFunction->setPage('blogs_single_page'); ?>&blog=<?php echo base64_encode(base64_encode($row['ID'])); ?>" class="btn btn-primary">Read More</a>
                                    </div>
                                 </div>
                              </div>
                     <?php  }
