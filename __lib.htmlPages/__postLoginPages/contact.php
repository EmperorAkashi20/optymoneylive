    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-7">
                ...
                <form action="ajax-request/ajax_response.php?action=contactus&subaction=submit" method="post" name="contact-form" id="contact-form" onSubmit="contactusJS(this);return false;">
                    <div class="row">
                        <div class="col-md-12">
