...
<head>
   ...
   <link rel="shortcut icon" type="image/png" href="https://test.taxnsave.in/static/th_4/img/favicon.png"/>
   <link rel='shortcut icon' type='image/x-icon' href='https://test.taxnsave.in/static/th_4/img/favicon.ico' />
   <style type="text/css">
      table td, th {
      padding: 5px;
...
<body>
   <div id="body">
      ...
      <br><br><br>
      <center><b><u>WILL REGISTRATION DETAILS</u></b></center>
      <br>
      <table id="example" class="display" style="width:90%; margin-left:5%; margin-right:5%" border="1">
         ...
         <?php
            $result_set=$commonFunction->will_user();
         ...
         <tr>
            ...
            <td><?php echo $res['pi_place']; ?></td>
            <td><?php echo $res['pi_per_state']; ?></td>
             <td><?php echo $res['pi_panaadharnum']; ?></td>
