...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <?php
                    ...
                    if ($status == 1) {
                        ?>
                        <form class="loginForm" role="form" method="post" action="?activeTab=tabTAXFilling&module_interface=<?php  echo $commonFunction->setPage('itr_forms'); ?>"
        ...
        <?php
                    if ($status == 0) {
                        ?>
        <form class="loginForm" role="form" method="post" action="?module_interface=<?php  echo $commonFunction->setPage('fill_itr'); ?>"
									name="payment_failed">
            <div class="card">
                <div class="card-body">
                    <div id="page-content">
