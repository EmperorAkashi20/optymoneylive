                        ...
                        <div class="form-group">
                           ...
                           <div class="styled-select clearfix">
                              <select class="wide required form-control" name="r_of_nominee_w_app" id="r_of_nominee_w_app">
                                 ...
                                 <option value="Father" <?=$ucc_data['r_of_nominee_w_app'] == 'Father' ? ' selected="selected"' : '';?>>Father</option>
                                 <option value="Mother" <?=$ucc_data['r_of_nominee_w_app'] == 'Mother' ? ' selected="selected"' : '';?>>Mother</option>
                                 <option value="Brother" <?=$ucc_data['r_of_nominee_w_app'] == 'Brother' ? ' selected="selected"' : '';?>>Brother</option>
                                 <option value="Sister" <?=$ucc_data['r_of_nominee_w_app'] == 'Sister' ? ' selected="selected"' : '';?>>Sister</option>
                                 <option value="Spouse" <?=$ucc_data['r_of_nominee_w_app'] == 'Spouse' ? ' selected="selected"' : '';?>>Spouse</option>
                                 <option value="Son" <?=$ucc_data['r_of_nominee_w_app'] == 'Son' ? ' selected="selected"' : '';?>>Son</option>
                                 <option value="Mother" <?=$ucc_data['r_of_nominee_w_app'] == 'Mother' ? ' selected="selected"' : '';?>>Daughter</option>
                              </select>
                           </div>
                        </div>
                     </div>
