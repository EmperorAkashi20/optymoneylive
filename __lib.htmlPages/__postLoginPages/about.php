<header class="masthead" style="background-image: url('<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme_new; ?>img/bannerBG.svg');">
  <div class="container h-100">
  	<!-- <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme_new; ?>img/tax1_vector.svg" class="vector"/> -->
    <div class="row h-100 align-items-center">
      <div class="col-12 text-left">
        <h1 class="font-weight-light wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">WHO WE ARE</h1>
        <p class="lead date wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">FINANCE SIMPLIFIED</p>
      </div>
    </div>
  </div>
</header>
    <!-- challenge_plan_area_start  -->
    <div class="challenge_plan_area">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4">
               <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme_new; ?>img/Main-Banner-Image.jpg" />
                </div>
           ...
           <div class="row  mt-40">
                <div class="col-lg-4 col-md-4">
                    <div class="single_trafic  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single_trafic wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                        <h4>Our Vision</h4>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single_trafic wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                        <h4>Our Mission</h4>
                        <p>To enable  our customers reach their financial independence and achieve their financial goals.</p>
                    </div>
                </div>
            </div>
                     <h4>Our Social Initiatives</h4>
...
<li>Data information confidentiality.</li>
                  ...
                  <img src="<?php echo $CONFIG->staticURL;?><?php echo $CONFIG->theme_new; ?>img/aboutus1.png" alt="about" class="about_imagess" />
            </div>
        </div>
