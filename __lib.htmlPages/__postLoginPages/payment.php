            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">Select your income for AY 2018-19 (FY 2017-18)</p>
                                ...
                                <form class="paymentForm" role="form" method="post"
                                                        ...
                                                        <label   for="incomefrombusiness">Income form  Business - Turnover or Gross receipts less than Rs. 2 Crores or Income from Profession - Gross receipts less than 25 Lakhs<p class="small"> For any other cases, please consult a CA</p></label><hr/>
                                                                        </div>
                                                                    <div class="col-md-12">
                                                        ...
                                                        <label   for="anyotherincome">Any other income</label><hr/>
                                                            ...
                                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <button type="submit" class="btn btn-success">Proceed to payment</button><hr/>
                                                                        </div>
                                                                </div>  
